...
public class MultiGlobalDeclarationList extends GlobalDeclarationList {

    private GlobalDeclarationList GlobalDeclarationList;
    private GlobalDeclaration GlobalDeclaration;

    public MultiGlobalDeclarationList (GlobalDeclarationList GlobalDeclarationList, GlobalDeclaration GlobalDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiGlobalDeclarationList(\n");
