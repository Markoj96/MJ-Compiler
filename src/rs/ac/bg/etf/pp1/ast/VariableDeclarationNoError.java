...
public class VariableDeclarationNoError extends VariableDeclaration {

    private Type Type;
    private VariableDeclarationList VariableDeclarationList;

    public VariableDeclarationNoError (Type Type, VariableDeclarationList VariableDeclarationList) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VariableDeclarationNoError(\n");
